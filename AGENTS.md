...
## Project Overview
This project is a premium portfolio website showcasing expertise as a **Full-Stack Developer** specializing in **AI, Blockchain, and 3D Graphics**. It demonstrates the ability to build high-performance, architecturally sound applications using the latest industry standards like **Next.js 15** and **React Router v7**.

### Core Objectives
- **Full-Stack Mastery**: Demonstrating end-to-end development capabilities from DB schema design to premium UI/UX.
- **Specialized Integration**: Showcasing deep integration of AI (LLMs), Blockchain (Web3), and 3D (WebGL/Three.js) technologies.
- **Framework Proficiency**: Highlighting expert-level usage of Next.js 15 and React Router v7.
- **Performance Excellence**: Adhering to Vercel's zero-bloat engineering standards for superior user experience.

### Key Expertise & Projects
- **3D Interactive Graphics**: [Three.js Lab](https://threejs-lab-orcin.vercel.app/) - Advanced WebGL visualizations and interactive 3D engines.
- **AI Integration**: [Chat Bot Choonsim](https://chat-bot-choonsim.vercel.app/home) - Intelligent AI agent implementation with a focus on seamless UX.
- **Blockchain & Fintech**: [BondBase](https://blockchain-bond-base.vercel.app/) - Transparent ESG investment platform leveraging blockchain technology.
- **Full-Stack Performance**: [C-Stay Blog](https://c-stay-blog-01.vercel.app/) - High-performance content platforms built with Next.js 15 and React Router v7.
...
- **[Strict Approval Rule]** 질문에 답변을 먼저하라. 답변후에 지시를 기다려라.
